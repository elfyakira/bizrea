...
export default async function CaseDetailPage({ params }: Props) {
  ...
  // 応募ボタンを非表示にする企業
  const hideApplyButton = ["tyk-promotion", "sugiura-hatsujo", "takaharu", "sorairo", "prelune", "paluu", "kiso", "norida-garden", "vital-core", "scrum", "hapikura", "mainichi-shukatsu", "nobodyknows", "herbzen-eva", "nagoya-hs-soccer", "kasugai-okashina", "prizeout", "waon", "teara"].includes(company.id);
