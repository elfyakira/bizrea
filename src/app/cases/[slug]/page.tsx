...
export default async function CaseDetailPage({ params }: Props) {
  ...
  // 応募ボタンを非表示にする企業
  const hideApplyButton = ["sorairo", "prelune", "paluu", "kiso", "norida-garden", "vital-core", "herbzen-eva", "mainichi-shukatsu", "kasugai-okashina", "nagoya-hs-soccer", "nobodyknows", "prizeout", "waon", "hapikura"].includes(company.id);
