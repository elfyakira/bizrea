...
export default async function CaseDetailPage({ params }: Props) {
  ...
  // 応募ボタンを非表示にする企業
  const hideApplyButton = ["sorairo", "prelune", "paluu", "kiso", "norida-garden", "vital-core", "scrum", "hapikura", "mainichi-shukatsu", "nobodyknows", "herbzen-eva", "nagoya-hs-soccer"].includes(company.id);
