  ...
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        content: "ー独立してから、一番苦しかった出来事は何でしたか。\n\n10年ほどお世話になった農園を辞めた後、次の場所へ移るまでに2〜4ヶ月ほど空いていた時期がありました。その間も働かなければいけなかったため、少しの間、鳶の仕事をしていたんです。\n\nただ、僕は高所恐怖症でして、絶対にやりたくない仕事でした。毎日嫌で、あの時は本当に辛かったですね。もちろん、鳶の仕事をしている方たちは本当にすごいと思います。安全帯を付けて、高い場所で作業をされる姿を見て、ものすごいスキルだと感じました。\n\nただ、自分は最後まで高いところを克服できませんでした。でも今振り返ると、40歳手前で一番辛い経験ができて良かったとも思っています。\n\nその後、独立して自分で農業を始めました。ただ、自分でやり始めた場所が「来年からは使えません」となった時は、やっぱりどうしようかなと悩みました。\n\nいろいろありましたが、今こうして地べたで働いているのは最高ですね。\n\nーその苦しかった時期は、どのように乗り越えたのでしょうか。\n\nコロナが理由です。仕事が全部止まるという状況になって、それで「辞めます」と言って、辞めました。もちろん大変な時期ではありましたが、自分にとっては農業へ戻るきっかけにもなりました。",
      },
      {
