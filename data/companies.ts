...
export const companies: Company[] = [
  ...
  },
  {
    ...
    presidentImage: "/images/companies/kiso-president.jpg",
    imagePosition: "center 30%",
    heroImage: "",
    founded: "",
    address: "",
    ...
    chapters: [
      {
        ...
        content: "ーまず、現在の事業内容について教えてください。\n\n私たちは、機械設計の中でも、工場にある生産設備や自動化のFA設備、物を運ぶ搬送装置などの設計を行っています。分かりやすく言うと、部品を組み立てたり、組み付けたりするための装置、あるいは物を右から左へ運ぶ、上下させるといった搬送装置を設計しています。製造現場の中で必要とされる設備や装置を、設計という立場から形にしていく仕事です。基本的には、自動車メーカー様や、工場の生産設備を作っている製造業様に向けた仕事になります。\n\nーなぜ、この事業を始めようと思われたのでしょうか。\n\n私は、機械設計を30年以上続けてきました。その中で、お客様のニーズに応えるためには、まずしっかりヒアリングをして、何を求められているのかを理解することが大切だと感じてきました。また、設計者が少ないという状況であったので、そうした中で、自分がこれまで続けてきた機械設計の経験を活かせば、お客様の要望に応えていくことができるのではないかと思いました。それが、この事業を進めていこうと考えた理由です。\n\nー起業を決意された理由を教えてください。\n\n30年以上、設計を続けてきた中でお客様のニーズに応えていこうというところから始まっていたんですが、決意した直接的な要因は、もともとは、勤めていた会社で在宅で仕事をしていました。ロケーションの関係もあってそうした働き方をしていたのですが、それが少し難しくなってきたことで、元々自分の中にあった思いを、自分の形にしてみようと考えました。それが、起業を決意した理由です。",
      },
      {
        title: "30年積み重ねてきた、設計の経験",
        content: "ー起業前は、どのようなお仕事をされていたのでしょうか。\n\n今と同じく、機械設計の仕事をずっと続けてきました。特に専門としてやってきたのは、自動車業界の設備設計です。そのほか、特殊なものではタンクローリーの設計にも関わってきました。「作ってきた」と言っても、私が担当していたのは図面だけなんですけど、製造業において設計は、ものづくりの始まりになる部分だと思っています。製造業の一番の末端といいますか、そこから形が生まれていく。その設計という仕事を、これまでずっと続けてきましたし、これからも続けていきたいと考えています。\n\nーその経験は、現在の事業にどのようにつながっていますか。\n\n設計をしている中で大切なのは、ただ図面を書くことではありません。お客様の要望がどこまで求められているのかを理解することです。「こういう図面を書いてほしい。」「こういうものが欲しい。」というだけではなく、「こういうところ足りていませんか？」といったことを、構想段階から提案していくことも仕事の一つです。そのためには、お客様の話を聞きながら、どこに課題があるのか、何を求めているのかを理解する必要があります。そうした経験は、今の事業にも活かされていると思います。設計の仕事は、図面として見える形になる前の段階がとても大切です。お客様の頭の中にあるイメージをどう形にするかを考える。これまでの経験の中で、その部分を大切にしてきました。",
      },
      {
