...
export const companies: Company[] = [
  ...
  },
  {
    ...
    url: "",
    recruitmentUrl: "",
    leadText: "私たちが扱っているのは、命です——。感謝の心でお預かりした和牛を一頭買いで、余すことなく国内外へ届ける。株式会社愛正の柳賢一氏は、お米の相談から畜産バイヤーとの縁を経て食肉卸事業へと飛び込み、104年余り3代続く精肉のバトンを受け継いだ。「過去はすべておかげさまに変える」「心を温かきは万能なり」——人の痛みが分かる経営者でありたいと語る、その原点と信念に迫る。",
    interviewDate: "",
    videoId: "",
    chapters: [
      {
