  ...
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...
        content: "ー独立してから、一番苦しかった出来事は何でしたか。\n\n自分でやり始めた場所が、「来年からは使えません」となった時は、やっぱりどうしようかなと悩んでいました。それから、農業を辞めて次の場所へ行くまでの間に、2〜4ヶ月ぐらい空いていた時期がありました。その間も働かなければいけなかったので、少しの間、鳶の仕事をしていたんです。\n\nただ、僕は高所恐怖症でして、絶対にやりたくない仕事でした。毎日嫌で、あの時は辛かったです。でも、今振り返ると良かったとも思います。40歳手前で一番辛い経験ができて良かったなと。\n\nもちろん、鳶の仕事をしている方たちは本当にすごいです。安全帯を付けて、ものすごいスキルで作業されているので、そこは心からすごいと思います。ただ、自分は高いところを克服できませんでしたので、だから今、こうして地べたで働いているのは最高ですね。\n\nーその苦しかった時期は、どのように乗り越えたのでしょうか。\n\nコロナが理由です。仕事が全部止まるという状況になって、それで「辞めます」と言って、辞めました。もちろん大変な時期ではありましたが、自分にとっては農業へ戻るきっかけにもなりました。",
      },
      {
