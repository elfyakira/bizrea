...
export const companies: Company[] = [
  ...
  },
  {
    ...
    chapters: [
      {
        ...
        content: "ーまず、現在の事業内容について教えてください。\n\n紀創機械設計では、機械設計の中でも、工場にある生産設備や自動化のFA設備、物を運ぶ搬送装置などの設計を行っています。分かりやすく言うと、部品を組み立てたり、組み付けたりするための装置、あるいは物を右から左へ運ぶ、上下させるといった搬送装置を設計しています。製造現場の中で必要とされる設備や装置を、設計という立場から形にしていく仕事です。基本的には、自動車メーカー様や、工場の生産設備を作っている製造業様に向けた仕事になります。\n\nーなぜ、この事業を始めようと思われたのでしょうか。\n\n私は、機械設計を30年以上続けてきました。その中で、お客様のニーズに応えるためには、まずしっかりヒアリングをして、何を求められているのかを理解することが大切だと感じてきました。また、製造業では設計者不足に悩む企業が多く、これまで培ってきた機械設計の経験を活かすことで、そうした企業の力になれるのではないかと考えたことが、事業を始めた理由です。そうした中で、自分がこれまで続けてきた機械設計の経験を活かせば、お客様の要望に応えていくことができるのではないかと思いました。\n\nー起業を決意された理由を教えてください。\n\n30年以上、設計を続けてきた中でお客様のニーズに応えていこうというところから始まっていたんですが、決意した直接的な要因は、もともとは、勤めていた会社で在宅で仕事をしていました。ロケーションの関係もあってそうした働き方をしていたのですが、それが少し難しくなってきたことで、元々自分の中にあった思いを、自分の形にしてみようと考えました。それが、起業を決意した理由です。",
      },
      {
        title: "30年積み重ねてきた、設計の経験",
        content: "ー起業前は、どのようなお仕事をされていたのでしょうか。\n\n今と同じく、機械設計の仕事をずっと続けてきました。特に専門としてやってきたのは、自動車業界の設備設計です。そのほか、特殊なものではタンクローリーの設計にも関わってきました。「作ってきた」と言っても、私が担当していたのは主に設計および図面作成の部分です。製造業において設計は、製造業の中でも、ものづくりの出発点になる部分だと思っています。そこから実際の形が生まれていき、形が生まれていく。その設計という仕事を、これまでずっと続けてきましたし、これからも続けていきたいと考えています。\n\nーその経験は、現在の事業にどのようにつながっていますか。\n\n設計をしている中で大切なのは、ただ図面を書くことではありません。お客様の要望がどこまで求められているのかを理解することです。「こういう図面を書いてほしい。」「こういうものが欲しい。」というだけではなく、「こういうところ足りていませんか？」といったことを、構想段階から提案していくことも仕事の一つです。そのためには、お客様の話を聞きながら、どこに課題があるのか、何を求めているのかを理解する必要があります。そうした経験は、今の事業にも活かされていると思います。設計の仕事は、図面として見える形になる前の段階がとても大切です。お客様の頭の中にあるイメージをどう形にするかを考える。これまでの経験の中で、その部分を大切にしてきました。",
      },
      {
        title: "未知だった営業と、家族の支え",
        content: "ー起業前に不安だったことはありますか。\n\n一番不安だったのは、継続して仕事を取ってこられるかどうかというところです。ずっと技術畑を歩んできましたので、設計については長く経験してきましたが、営業に関しては未知の世界でした。そこで自分で営業をして、仕事を継続していけるのかという不安はありました。それでも、お客様が困っていることは必ずあると思って、そのニーズを探していくことが大事になってくると感じています。技術の仕事をしていると、どうしても目の前の設計や図面に集中することが多くなります。けれど、起業して自分で事業を進めていく以上、まず知ってもらうこと、そして信頼関係を築いていくことが必要になるので、その部分は、自分にとって新しい挑戦でもあります。\n\nー実際に始めてみて、感じたギャップはありますか。\n\n大きなギャップというほどの差を感じたわけではありません。ただ、もともと不安に思っていた営業力の部分については、やはり難しさを痛感しています。BtoBの仕事になりますので、信頼関係を築いていくことが大切ですが、その前に、まず自分たちのことを知ってもらう必要があります。そこがとても難しいと、今も実感しています。設計の技術や経験があっても、それを必要としているお客様に届かなければ仕事にはつながりません。だからこそ、技術者としての経験だけでなく、どうすれば知ってもらえるのか、どうすれば信頼してもらえるのかという部分にも向き合っていく必要があると感じています。\n\nー大変な時に支えになっているものは何ですか。\n\n一番支えになっているのは、やはり家族の存在です。自分が悩んでいる時に、家族が「こうした方がいいんじゃないか」とアドバイスしてくれることがあります。何かを手伝ってくれたり、バックアップしてくれたりすることもあります。個人で仕事をしていると、人に聞くタイミングが中々どうしても無いこともあります。そういう時に、身近で話を聞いてくれる存在がいることは大きいです。また、家族のために頑張ろうと思えることも、支えの一つになっています。自分一人で仕事をしているようでいて、実際には家族の支えがあって続けられている部分があると思っています。",
      },
      {
    ...
    quotes: [
      ...
      "「誰でもできる」仕事をつくっていきたい。健常者の方も障害者の方も、同じフィールドで働ける——そんなものづくりを目指しています。",
    ],
    photos: [],
    companyInfo: [
