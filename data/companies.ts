...
export const companies: Company[] = [
  ...
  },
  {
    ...
    region: "その他",
    president: "代表 長江 有祐",
    catchphrase: "まずは、ラグビーを楽しんでほしい——自分で考え、自分から動ける選手へ",
    desc: "「まずは、ラグビーを楽しんでほしい」と語る、一般社団法人スクラムの長江有祐氏。言われたことをそのまま行うのではなく、時には常識を疑い、「もっと良くするにはどうすればいいのか」と仮説を立てて自分から試してみる。自分で考えて行動する選手は、ラグビー選手として成長するだけではないという思いのもと、選手と向き合っている。",
    image: "",
    heroImage: "",
    founded: "",
    address: "",
    ...
    url: "",
    recruitmentUrl: "",
    leadText: "「まずは、ラグビーを楽しんでほしい」——一般社団法人スクラムの長江有祐氏が、選手たちに最初に伝える言葉だ。そのうえで求めるのは、自分で考え、自分から動くこと。言われたことをそのまま行うのではなく、時には常識を疑い、仮説を立てて試してみる。自分で考えて行動する選手は、ラグビー選手として成長するだけではない——その思いに迫る。",
    interviewDate: "",
    videoId: "",
    chapters: [
      {
        title: "選手たちへ伝えたいこと",
        content: "まずは、ラグビーを楽しんでほしいです。\n\nそのうえで、自分で考え、行動してほしいと思います。言われたことをそのまま行うのではなく、時には常識を疑い、「もっと良くするにはどうすればいいのか」と仮説を立てて、自分から試してみてください。\n\n自分で考えて行動する選手は、ラグビー選手として成長するだけではありません。ラグビーのキャリー人生を歩んでほしいと思っています。",
      },
    ],
    quotes: [
      "まずは、ラグビーを楽しんでほしいです。",
      "自分で考えて行動する選手は、ラグビー選手として成長するだけではありません。",
    ],
    photos: [],
    companyInfo: [
